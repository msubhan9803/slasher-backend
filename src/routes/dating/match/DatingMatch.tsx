...
import CustomRoundImageButton from '../../../components/ui/CustomRoundImageButton';
      ...
      <div className="mt-5 pt-5 mt-md-0 pt-md-0">
        ...
        <Row className="col-12  col-sm-4 text-center m-auto">
          ...
          <div className="d-flex justify-content-center">
            <span className="">
              <img style={{}} src={mapPinIcon} alt="Map Icon Here" />
            </span>
            <div className="text-muted ms-1">{location}</div>
          </div>
          <RoundButton className="mx-2 text-white bg-black border-white my-4" onClick={() => {}}>
            View Profile
          </RoundButton>
        </Row>

        <Row className="d-flex justify-content-center">
          <CustomRoundImageButton
            className="col-3 col-md-2"
            label="Pass"
            onClick={() => {}}
            src={passIcon}
            alt="Pass Button Here"
          />
          <CustomRoundImageButton
            className="col-3 col-md-2"
            label="Undo"
          ...
          <CustomRoundImageButton
            ...
            onClick={() => {}}
            src={likeIcon}
            alt="Like Button Here"
          />
        </Row>

        <Row className="col-6 m-auto mt-5">
          <RoundButton className="mx-2" onClick={() => handleMatch('Subscriber')}>
            Subscriber match
          </RoundButton>
          <RoundButton className="mx-2 mt-3" onClick={() => handleMatch('Non-Subscriber')}>
            Non-subscriber match
          </RoundButton>
        </Row>
        <DatingMatchModal
